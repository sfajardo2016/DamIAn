...
uses
  ...
  Grids, SkinData, ExtCtrls, SkinGrids, spColorCtrls;
...
type
  ...
  TspPropertyEditor = class(TspSkinStringGrid)
  private
  ...
  published
    ...
    property ColorDialog: TspSkinColorDialog  read  FColorDlg write  FColorDlg;
  end;


  TspSkinViewer = class(TGraphicControl)
  private
...
begin
  ...
  RegisterComponents('Samples', [TspSkinViewer]);
end;
...
constructor TspSkinViewer.Create(AOwner: TComponent);
begin
  inherited;
